...
describe Sunspot::SessionProxy::MasterSlaveSessionProxy do
  ...
  {
    :master_session => Sunspot::Session.public_instance_methods(false) - [:search, 'search', :new_search, 'new_search', :more_like_this, 'more_like_this', :new_more_like_this, 'new_more_like_this', :retry_search, 'retry_search', :new_retry_search, 'new_retry_search', :config, 'config'],
    :slave_session => [:search, :new_search, :more_like_this, :new_more_like_this, :retry_search, :new_retry_search]
